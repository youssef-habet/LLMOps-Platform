...
export default function DeleteDatasetModal({ 
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 animate-fade-in">
      <div className="animate-slide-up bg-[#171717] border border-white/10 rounded-2xl w-full max-w-sm overflow-hidden shadow-2xl">
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <div>
              <h2 className="text-lg font-semibold text-white">Delete Dataset</h2>
              <p className="text-sm text-gray-400 mt-1">
                Are you sure you want to delete <span className="text-white font-medium">"{datasetName}"</span>? 
              </p>
              <p className="text-xs text-red-400 mt-2 font-medium">
                This will also permanently remove the CSV file from storage.
              </p>
            </div>
          </div>
